...
tp = new Typograf({lang: 'ru', mode: 'name'});

slugs = titles.map(function(str) {
  return url_slug(str.replace(/\+/g, ''));
})

titles = titles.map(function(str) {
...
function url_slug(s, opt) {
  ...
  var alnum = (typeof(XRegExp) === 'undefined') ? RegExp('[^a-z0-9]+', 'ig')
  : XRegExp('[^\\p{L}\\p{N}]+', 'ig');
